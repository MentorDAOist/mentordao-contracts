...
library MentorTokenURILogic {
            ...
            abi.encodePacked(
                ...
                Base64Upgradeable.encode(
                    abi.encodePacked(
                        ...
                        StringsUpgradeable.toString(followers),
        ...
        returns (string memory)
    {
        return Base64Upgradeable.encode(
            abi.encodePacked(
                ...
                StringsUpgradeable.toString(_handleLengthToFontSize(bytes(handleWithAtSymbol).length)),
    ...
    function _handleLengthToFontSize(uint256 handleLength) internal pure returns (uint256) {
        return handleLength <= MAX_HANDLE_LENGTH_WITH_DEFAULT_FONT_SIZE
            ? DEFAULT_FONT_SIZE
